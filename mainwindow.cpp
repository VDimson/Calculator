...

{
    ...
    connect(ui->pushButton_umnogenie,SIGNAL(clicked()),this,SLOT(math_operations()));
    connect(ui->pushButton_plus,SIGNAL(clicked()),this,SLOT(math_operations()));
    connect(ui->pushButton_minus,SIGNAL(clicked()),this,SLOT(math_operations()));
    ui->pushButton_delenie->setCheckable(true);
    ui->pushButton_umnogenie->setCheckable(true);
...
{
 //проверим , если символ "." в строке result_show
...
void MainWindow::on_pushButton_ravno_clicked()
{
 ...
 num_second=ui->result_show->text().toDouble();
    ...
    if (ui->pushButton_minus->isChecked())
     ...
     if (ui->pushButton_umnogenie->isChecked())
        {
         labelNumber=num_first * num_second;
     ...
     if (ui->pushButton_delenie->isChecked())
         {
         if (num_second==0)
         {
